CREATE DATABASE NirzhorKnitwear
use NirzhorKnitwear
...
insert into BuyingHouse (BuyingHouseName) values ('GOURAV') ,
('Unique Jeans'),
('NITEX'),
('Koala'),
('June International'),
...
select * from OrderInput
select * from DailyReportInput
select * from ProductionStatus


select * from IncomeReport
